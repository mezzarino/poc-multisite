  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-white py-2">
      <main className="mx-auto w-auto px-4 pb-8 pt-16 sm:pt-24 lg:px-8">
        <h1 className="mx-auto text-center font-mono text-6xl font-extrabold tracking-tight text-green-600 sm:text-7xl lg:text-8xl xl:text-8xl">
          Brand C on Funnel project
        </h1>
        <Link href="/">Home</Link>
      </main>
      <div className="mx-auto mt-12 w-1/2 border border-green-600 p-4 text-green-600">
